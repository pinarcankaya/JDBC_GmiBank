...
public class DatabaseConnector {
    ...
    private static final String dbpassword = ConfigurationReader.getProperty("passwordMysql");
    private static final String connectionUrl = ConfigurationReader.getProperty("db_urlMysql");
